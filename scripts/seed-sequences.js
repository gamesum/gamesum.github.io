...
const sequences = [
  ...
  },
  {
    ...
    previewColors: ['#001a33', '#ffffff', '#c8921e'],
    thumbnailGradient: 'linear-gradient(135deg, #001a33 0%, #ffffff 40%, #c8921e 100%)',
    status: 'published',
    downloadCount: 198,
    hasMp3: false,
    songName: '',
  ...
  },
  {
    ...
    previewColors: ['#0a001a', '#ffffff', '#c8921e'],
    thumbnailGradient: 'linear-gradient(135deg, #0a001a 0%, #ffffff 50%, #c8921e 100%)',
    status: 'published',
    downloadCount: 871,
    hasMp3: false,
    songName: '',
